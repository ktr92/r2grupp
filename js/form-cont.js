jQuery(document).ready(function ($) {
    if (document.querySelector('#contact-form-p')) {
        ...
        $('#contact-form-p input, #contact-form-p textarea').on('blur', function () {
            $('#contact-form-p input, #contact-form-p textarea').removeClass('error');
            ...
            success: function (request, xhr, status, error) {
                ...
                if (request.success === true) {
                    ...
                    $.each(request.data, function (key, val) {
                        ...
                        $('#btn-contact-form-p').before('<span class="error-' + key + '">' + val + '</span>');
                    });
